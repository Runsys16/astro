...
//
//--------------------------------------------------------------------------------------------------------------------
void PanelStdOut::change_tab_size()
{
	if ( bChangeTab == false )
	{
		vector<int>& t = pScroll->getvTabSize();
		tTabOld.clear();
		for( int i=0; i<t.size(); i++ )
		{
			tTabOld.push_back( t[i] );
		}
		bChangeTab = true;
	}
}
...
//
//--------------------------------------------------------------------------------------------------------------------
void PanelStdOut::add_tab_size(int n)
{
	tTabNew.push_back( n );
	//bChangeTab = true;
}
...
//
//--------------------------------------------------------------------------------------------------------------------
void PanelStdOut::restaure_tab_size()
{
	bChangeTab = false;
	tTabNew.clear();
