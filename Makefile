...
$(OBJDIR)camera.o :   $(SRCDIR)camera.cpp $(SRCDIR)camera.h $(SRCDIR)v4l2.h $(SRCDIR)control.h $(SRCDIR)MathlibD.h $(SRCDIR)main.h $(SRCDIR)button_callback.h $(SRCDIR)surveillance.h $(SRCDIR)var_mgr.h $(SRCDIR)Singleton.h $(SRCDIR)panel_courbe.h $(SRCDIR)console.h $(SRCDIR)panel_console_serial.h $(SRCDIR)serial.h $(SRCDIR)serveur_mgr.h $(SRCDIR)timer.h $(SRCDIR)stars.h $(SRCDIR)star.h $(SRCDIR)panel_zoom.h $(SRCDIR)panel_camera.h $(SRCDIR)catalog.h $(SRCDIR)star_catalogue.h $(SRCDIR)convert.h $(SRCDIR)find_star.h $(SRCDIR)panel_graph.h $(SRCDIR)notification.h $(SRCDIR)panel_debug.h $(SRCDIR)star_compare.h $(SRCDIR)camera_mgr.h $(SRCDIR)file_browser.h $(SRCDIR)panel_dir.h $(SRCDIR)panel_file.h
	@echo ---------   compilation de $@
	$(GPP) -c $< -o $@  $(CFLAGS)

#--- Fabrication de camera_mgr.o -----------------------------------------
$(OBJDIR)camera_mgr.o :   $(SRCDIR)camera_mgr.cpp $(SRCDIR)camera_mgr.h $(SRCDIR)camera.h $(SRCDIR)v4l2.h $(SRCDIR)control.h $(SRCDIR)MathlibD.h $(SRCDIR)main.h $(SRCDIR)button_callback.h $(SRCDIR)surveillance.h $(SRCDIR)var_mgr.h $(SRCDIR)Singleton.h $(SRCDIR)panel_courbe.h $(SRCDIR)console.h $(SRCDIR)panel_console_serial.h $(SRCDIR)serial.h $(SRCDIR)serveur_mgr.h $(SRCDIR)timer.h $(SRCDIR)stars.h $(SRCDIR)star.h $(SRCDIR)panel_zoom.h $(SRCDIR)panel_camera.h $(SRCDIR)catalog.h $(SRCDIR)star_catalogue.h $(SRCDIR)convert.h $(SRCDIR)find_star.h $(SRCDIR)panel_graph.h $(SRCDIR)notification.h $(SRCDIR)panel_debug.h $(SRCDIR)star_compare.h $(SRCDIR)pleiade.h
	@echo ---------   compilation de $@
	$(GPP) -c $< -o $@  $(CFLAGS)

#--- Fabrication de capture.o -----------------------------------------
$(OBJDIR)capture.o :   $(SRCDIR)capture.cpp $(SRCDIR)capture.h $(SRCDIR)camera.h $(SRCDIR)v4l2.h $(SRCDIR)control.h $(SRCDIR)MathlibD.h $(SRCDIR)main.h $(SRCDIR)button_callback.h $(SRCDIR)surveillance.h $(SRCDIR)var_mgr.h $(SRCDIR)Singleton.h $(SRCDIR)panel_courbe.h $(SRCDIR)console.h $(SRCDIR)panel_console_serial.h $(SRCDIR)serial.h $(SRCDIR)serveur_mgr.h $(SRCDIR)timer.h $(SRCDIR)stars.h $(SRCDIR)star.h $(SRCDIR)panel_zoom.h $(SRCDIR)panel_camera.h $(SRCDIR)catalog.h $(SRCDIR)star_catalogue.h $(SRCDIR)convert.h $(SRCDIR)find_star.h $(SRCDIR)panel_graph.h $(SRCDIR)notification.h $(SRCDIR)panel_debug.h $(SRCDIR)star_compare.h $(SRCDIR)panel_capture.h $(SRCDIR)fits.h $(SRCDIR)panel_fits.h $(SRCDIR)panel_fits_correction.h $(SRCDIR)captures.h
	@echo ---------   compilation de $@
	$(GPP) -c $< -o $@  $(CFLAGS)

#--- Fabrication de captures.o -----------------------------------------
$(OBJDIR)captures.o :   $(SRCDIR)captures.cpp $(SRCDIR)captures.h $(SRCDIR)main.h $(SRCDIR)MathlibD.h $(SRCDIR)button_callback.h $(SRCDIR)surveillance.h $(SRCDIR)var_mgr.h $(SRCDIR)Singleton.h $(SRCDIR)panel_courbe.h $(SRCDIR)console.h $(SRCDIR)panel_console_serial.h $(SRCDIR)serial.h $(SRCDIR)serveur_mgr.h $(SRCDIR)timer.h $(SRCDIR)capture.h $(SRCDIR)camera.h $(SRCDIR)v4l2.h $(SRCDIR)control.h $(SRCDIR)stars.h $(SRCDIR)star.h $(SRCDIR)panel_zoom.h $(SRCDIR)panel_camera.h $(SRCDIR)catalog.h $(SRCDIR)star_catalogue.h $(SRCDIR)convert.h $(SRCDIR)find_star.h $(SRCDIR)panel_graph.h $(SRCDIR)notification.h $(SRCDIR)panel_debug.h $(SRCDIR)star_compare.h $(SRCDIR)panel_capture.h $(SRCDIR)fits.h $(SRCDIR)panel_fits.h $(SRCDIR)panel_fits_correction.h
	@echo ---------   compilation de $@
	$(GPP) -c $< -o $@  $(CFLAGS)

#--- Fabrication de catalog.o -----------------------------------------
$(OBJDIR)catalog.o :   $(SRCDIR)catalog.cpp $(SRCDIR)catalog.h $(SRCDIR)main.h $(SRCDIR)MathlibD.h $(SRCDIR)button_callback.h $(SRCDIR)surveillance.h $(SRCDIR)var_mgr.h $(SRCDIR)Singleton.h $(SRCDIR)panel_courbe.h $(SRCDIR)console.h $(SRCDIR)panel_console_serial.h $(SRCDIR)serial.h $(SRCDIR)serveur_mgr.h $(SRCDIR)timer.h $(SRCDIR)star_catalogue.h $(SRCDIR)camera_mgr.h $(SRCDIR)camera.h $(SRCDIR)v4l2.h $(SRCDIR)control.h $(SRCDIR)stars.h $(SRCDIR)star.h $(SRCDIR)panel_zoom.h $(SRCDIR)panel_camera.h $(SRCDIR)convert.h $(SRCDIR)find_star.h $(SRCDIR)panel_graph.h $(SRCDIR)notification.h $(SRCDIR)panel_debug.h $(SRCDIR)star_compare.h $(SRCDIR)panel_stdout.h
	@echo ---------   compilation de $@
	$(GPP) -c $< -o $@  $(CFLAGS)

#--- Fabrication de connexion_mgr.o -----------------------------------------
$(OBJDIR)connexion_mgr.o :   $(SRCDIR)connexion_mgr.cpp $(SRCDIR)connexion_mgr.h $(SRCDIR)MathlibD.h $(SRCDIR)main.h $(SRCDIR)button_callback.h $(SRCDIR)surveillance.h $(SRCDIR)var_mgr.h $(SRCDIR)Singleton.h $(SRCDIR)panel_courbe.h $(SRCDIR)console.h $(SRCDIR)panel_console_serial.h $(SRCDIR)serial.h $(SRCDIR)serveur_mgr.h $(SRCDIR)timer.h $(SRCDIR)camera_mgr.h $(SRCDIR)camera.h $(SRCDIR)v4l2.h $(SRCDIR)control.h $(SRCDIR)stars.h $(SRCDIR)star.h $(SRCDIR)panel_zoom.h $(SRCDIR)panel_camera.h $(SRCDIR)catalog.h $(SRCDIR)star_catalogue.h $(SRCDIR)convert.h $(SRCDIR)find_star.h $(SRCDIR)panel_graph.h $(SRCDIR)notification.h $(SRCDIR)panel_debug.h $(SRCDIR)star_compare.h
	@echo ---------   compilation de $@
	$(GPP) -c $< -o $@  $(CFLAGS)
...
$(OBJDIR)file_browser.o :   $(SRCDIR)file_browser.cpp $(SRCDIR)file_browser.h $(SRCDIR)main.h $(SRCDIR)MathlibD.h $(SRCDIR)button_callback.h $(SRCDIR)surveillance.h $(SRCDIR)var_mgr.h $(SRCDIR)Singleton.h $(SRCDIR)panel_courbe.h $(SRCDIR)console.h $(SRCDIR)panel_console_serial.h $(SRCDIR)serial.h $(SRCDIR)serveur_mgr.h $(SRCDIR)timer.h $(SRCDIR)panel_dir.h $(SRCDIR)camera.h $(SRCDIR)v4l2.h $(SRCDIR)control.h $(SRCDIR)stars.h $(SRCDIR)star.h $(SRCDIR)panel_zoom.h $(SRCDIR)panel_camera.h $(SRCDIR)catalog.h $(SRCDIR)star_catalogue.h $(SRCDIR)convert.h $(SRCDIR)find_star.h $(SRCDIR)panel_graph.h $(SRCDIR)notification.h $(SRCDIR)panel_debug.h $(SRCDIR)star_compare.h $(SRCDIR)panel_file.h
	@echo ---------   compilation de $@
	$(GPP) -c $< -o $@  $(CFLAGS)

#--- Fabrication de find_star.o -----------------------------------------
$(OBJDIR)find_star.o :   $(SRCDIR)find_star.cpp $(SRCDIR)find_star.h $(SRCDIR)main.h $(SRCDIR)MathlibD.h $(SRCDIR)button_callback.h $(SRCDIR)surveillance.h $(SRCDIR)var_mgr.h $(SRCDIR)Singleton.h $(SRCDIR)panel_courbe.h $(SRCDIR)console.h $(SRCDIR)panel_console_serial.h $(SRCDIR)serial.h $(SRCDIR)serveur_mgr.h $(SRCDIR)timer.h $(SRCDIR)convert.h $(SRCDIR)panel_graph.h $(SRCDIR)notification.h $(SRCDIR)panel_debug.h
	@echo ---------   compilation de $@
	$(GPP) -c $< -o $@  $(CFLAGS)

#--- Fabrication de fits.o -----------------------------------------
$(OBJDIR)fits.o :   $(SRCDIR)fits.cpp $(SRCDIR)fits.h $(SRCDIR)main.h $(SRCDIR)MathlibD.h $(SRCDIR)button_callback.h $(SRCDIR)surveillance.h $(SRCDIR)var_mgr.h $(SRCDIR)Singleton.h $(SRCDIR)panel_courbe.h $(SRCDIR)console.h $(SRCDIR)panel_console_serial.h $(SRCDIR)serial.h $(SRCDIR)serveur_mgr.h $(SRCDIR)timer.h $(SRCDIR)panel_fits.h $(SRCDIR)panel_capture.h $(SRCDIR)camera.h $(SRCDIR)v4l2.h $(SRCDIR)control.h $(SRCDIR)stars.h $(SRCDIR)star.h $(SRCDIR)panel_zoom.h $(SRCDIR)panel_camera.h $(SRCDIR)catalog.h $(SRCDIR)star_catalogue.h $(SRCDIR)convert.h $(SRCDIR)find_star.h $(SRCDIR)panel_graph.h $(SRCDIR)notification.h $(SRCDIR)panel_debug.h $(SRCDIR)star_compare.h $(SRCDIR)panel_fits_correction.h
	@echo ---------   compilation de $@
	$(GPP) -c $< -o $@  $(CFLAGS)

#--- Fabrication de lx200.o -----------------------------------------
$(OBJDIR)lx200.o :   $(SRCDIR)lx200.cpp $(SRCDIR)lx200.h $(SRCDIR)MathlibD.h $(SRCDIR)main.h $(SRCDIR)button_callback.h $(SRCDIR)surveillance.h $(SRCDIR)var_mgr.h $(SRCDIR)Singleton.h $(SRCDIR)panel_courbe.h $(SRCDIR)console.h $(SRCDIR)panel_console_serial.h $(SRCDIR)serial.h $(SRCDIR)serveur_mgr.h $(SRCDIR)timer.h $(SRCDIR)panel_debug.h $(SRCDIR)camera_mgr.h $(SRCDIR)camera.h $(SRCDIR)v4l2.h $(SRCDIR)control.h $(SRCDIR)stars.h $(SRCDIR)star.h $(SRCDIR)panel_zoom.h $(SRCDIR)panel_camera.h $(SRCDIR)catalog.h $(SRCDIR)star_catalogue.h $(SRCDIR)convert.h $(SRCDIR)find_star.h $(SRCDIR)panel_graph.h $(SRCDIR)notification.h $(SRCDIR)star_compare.h $(SRCDIR)captures.h $(SRCDIR)capture.h $(SRCDIR)panel_capture.h $(SRCDIR)fits.h $(SRCDIR)panel_fits.h $(SRCDIR)panel_fits_correction.h
	@echo ---------   compilation de $@
	$(GPP) -c $< -o $@  $(CFLAGS)

#--- Fabrication de main.o -----------------------------------------
$(OBJDIR)main.o :   $(SRCDIR)main.cpp $(SRCDIR)main.h $(SRCDIR)MathlibD.h $(SRCDIR)button_callback.h $(SRCDIR)surveillance.h $(SRCDIR)var_mgr.h $(SRCDIR)Singleton.h $(SRCDIR)panel_courbe.h $(SRCDIR)console.h $(SRCDIR)panel_console_serial.h $(SRCDIR)serial.h $(SRCDIR)serveur_mgr.h $(SRCDIR)timer.h $(SRCDIR)v4l2.h $(SRCDIR)control.h $(SRCDIR)camera.h $(SRCDIR)stars.h $(SRCDIR)star.h $(SRCDIR)panel_zoom.h $(SRCDIR)panel_camera.h $(SRCDIR)catalog.h $(SRCDIR)star_catalogue.h $(SRCDIR)convert.h $(SRCDIR)find_star.h $(SRCDIR)panel_graph.h $(SRCDIR)notification.h $(SRCDIR)panel_debug.h $(SRCDIR)star_compare.h $(SRCDIR)camera_mgr.h $(SRCDIR)connexion_mgr.h $(SRCDIR)pleiade.h $(SRCDIR)lx200.h $(SRCDIR)synscan.h $(SRCDIR)capture.h $(SRCDIR)panel_capture.h $(SRCDIR)fits.h $(SRCDIR)panel_fits.h $(SRCDIR)panel_fits_correction.h $(SRCDIR)alert_box.h $(SRCDIR)file_browser.h $(SRCDIR)panel_dir.h $(SRCDIR)panel_file.h $(SRCDIR)captures.h $(SRCDIR)bluetooth.h $(SRCDIR)panel_apn.h $(SRCDIR)panel_stdout.h $(SRCDIR)status.inc
	@echo ---------   compilation de $@
	$(GPP) -c $< -o $@  $(CFLAGS)
...
$(OBJDIR)panel_camera.o :   $(SRCDIR)panel_camera.cpp $(SRCDIR)panel_camera.h $(SRCDIR)main.h $(SRCDIR)MathlibD.h $(SRCDIR)button_callback.h $(SRCDIR)surveillance.h $(SRCDIR)var_mgr.h $(SRCDIR)Singleton.h $(SRCDIR)panel_courbe.h $(SRCDIR)console.h $(SRCDIR)panel_console_serial.h $(SRCDIR)serial.h $(SRCDIR)serveur_mgr.h $(SRCDIR)timer.h $(SRCDIR)stars.h $(SRCDIR)star.h $(SRCDIR)panel_zoom.h $(SRCDIR)catalog.h $(SRCDIR)star_catalogue.h $(SRCDIR)convert.h $(SRCDIR)find_star.h $(SRCDIR)panel_graph.h $(SRCDIR)notification.h $(SRCDIR)panel_debug.h $(SRCDIR)camera_mgr.h $(SRCDIR)camera.h $(SRCDIR)v4l2.h $(SRCDIR)control.h $(SRCDIR)star_compare.h
	@echo ---------   compilation de $@
	$(GPP) -c $< -o $@  $(CFLAGS)

#--- Fabrication de panel_capture.o -----------------------------------------
$(OBJDIR)panel_capture.o :   $(SRCDIR)panel_capture.cpp $(SRCDIR)panel_capture.h $(SRCDIR)camera.h $(SRCDIR)v4l2.h $(SRCDIR)control.h $(SRCDIR)MathlibD.h $(SRCDIR)main.h $(SRCDIR)button_callback.h $(SRCDIR)surveillance.h $(SRCDIR)var_mgr.h $(SRCDIR)Singleton.h $(SRCDIR)panel_courbe.h $(SRCDIR)console.h $(SRCDIR)panel_console_serial.h $(SRCDIR)serial.h $(SRCDIR)serveur_mgr.h $(SRCDIR)timer.h $(SRCDIR)stars.h $(SRCDIR)star.h $(SRCDIR)panel_zoom.h $(SRCDIR)panel_camera.h $(SRCDIR)catalog.h $(SRCDIR)star_catalogue.h $(SRCDIR)convert.h $(SRCDIR)find_star.h $(SRCDIR)panel_graph.h $(SRCDIR)notification.h $(SRCDIR)panel_debug.h $(SRCDIR)star_compare.h $(SRCDIR)panel_stdout.h $(SRCDIR)captures.h $(SRCDIR)capture.h $(SRCDIR)fits.h $(SRCDIR)panel_fits.h $(SRCDIR)panel_fits_correction.h
	@echo ---------   compilation de $@
	$(GPP) -c $< -o $@  $(CFLAGS)
...
$(OBJDIR)panel_dir.o :   $(SRCDIR)panel_dir.cpp $(SRCDIR)panel_dir.h $(SRCDIR)camera.h $(SRCDIR)v4l2.h $(SRCDIR)control.h $(SRCDIR)MathlibD.h $(SRCDIR)main.h $(SRCDIR)button_callback.h $(SRCDIR)surveillance.h $(SRCDIR)var_mgr.h $(SRCDIR)Singleton.h $(SRCDIR)panel_courbe.h $(SRCDIR)console.h $(SRCDIR)panel_console_serial.h $(SRCDIR)serial.h $(SRCDIR)serveur_mgr.h $(SRCDIR)timer.h $(SRCDIR)stars.h $(SRCDIR)star.h $(SRCDIR)panel_zoom.h $(SRCDIR)panel_camera.h $(SRCDIR)catalog.h $(SRCDIR)star_catalogue.h $(SRCDIR)convert.h $(SRCDIR)find_star.h $(SRCDIR)panel_graph.h $(SRCDIR)notification.h $(SRCDIR)panel_debug.h $(SRCDIR)star_compare.h $(SRCDIR)file_browser.h $(SRCDIR)panel_file.h
	@echo ---------   compilation de $@
	$(GPP) -c $< -o $@  $(CFLAGS)

#--- Fabrication de panel_file.o -----------------------------------------
$(OBJDIR)panel_file.o :   $(SRCDIR)panel_file.cpp $(SRCDIR)panel_file.h $(SRCDIR)camera.h $(SRCDIR)v4l2.h $(SRCDIR)control.h $(SRCDIR)MathlibD.h $(SRCDIR)main.h $(SRCDIR)button_callback.h $(SRCDIR)surveillance.h $(SRCDIR)var_mgr.h $(SRCDIR)Singleton.h $(SRCDIR)panel_courbe.h $(SRCDIR)console.h $(SRCDIR)panel_console_serial.h $(SRCDIR)serial.h $(SRCDIR)serveur_mgr.h $(SRCDIR)timer.h $(SRCDIR)stars.h $(SRCDIR)star.h $(SRCDIR)panel_zoom.h $(SRCDIR)panel_camera.h $(SRCDIR)catalog.h $(SRCDIR)star_catalogue.h $(SRCDIR)convert.h $(SRCDIR)find_star.h $(SRCDIR)panel_graph.h $(SRCDIR)notification.h $(SRCDIR)panel_debug.h $(SRCDIR)star_compare.h $(SRCDIR)file_browser.h $(SRCDIR)panel_dir.h
	@echo ---------   compilation de $@
	$(GPP) -c $< -o $@  $(CFLAGS)
...
$(OBJDIR)pleiade.o :   $(SRCDIR)pleiade.cpp $(SRCDIR)pleiade.h $(SRCDIR)camera.h $(SRCDIR)v4l2.h $(SRCDIR)control.h $(SRCDIR)MathlibD.h $(SRCDIR)main.h $(SRCDIR)button_callback.h $(SRCDIR)surveillance.h $(SRCDIR)var_mgr.h $(SRCDIR)Singleton.h $(SRCDIR)panel_courbe.h $(SRCDIR)console.h $(SRCDIR)panel_console_serial.h $(SRCDIR)serial.h $(SRCDIR)serveur_mgr.h $(SRCDIR)timer.h $(SRCDIR)stars.h $(SRCDIR)star.h $(SRCDIR)panel_zoom.h $(SRCDIR)panel_camera.h $(SRCDIR)catalog.h $(SRCDIR)star_catalogue.h $(SRCDIR)convert.h $(SRCDIR)find_star.h $(SRCDIR)panel_graph.h $(SRCDIR)notification.h $(SRCDIR)panel_debug.h $(SRCDIR)star_compare.h
	@echo ---------   compilation de $@
	$(GPP) -c $< -o $@  $(CFLAGS)
...
$(OBJDIR)serveur_mgr.o :   $(SRCDIR)serveur_mgr.cpp $(SRCDIR)serveur_mgr.h $(SRCDIR)MathlibD.h $(SRCDIR)main.h $(SRCDIR)button_callback.h $(SRCDIR)surveillance.h $(SRCDIR)var_mgr.h $(SRCDIR)Singleton.h $(SRCDIR)panel_courbe.h $(SRCDIR)console.h $(SRCDIR)panel_console_serial.h $(SRCDIR)serial.h $(SRCDIR)timer.h $(SRCDIR)camera_mgr.h $(SRCDIR)camera.h $(SRCDIR)v4l2.h $(SRCDIR)control.h $(SRCDIR)stars.h $(SRCDIR)star.h $(SRCDIR)panel_zoom.h $(SRCDIR)panel_camera.h $(SRCDIR)catalog.h $(SRCDIR)star_catalogue.h $(SRCDIR)convert.h $(SRCDIR)find_star.h $(SRCDIR)panel_graph.h $(SRCDIR)notification.h $(SRCDIR)panel_debug.h $(SRCDIR)star_compare.h $(SRCDIR)captures.h $(SRCDIR)capture.h $(SRCDIR)panel_capture.h $(SRCDIR)fits.h $(SRCDIR)panel_fits.h $(SRCDIR)panel_fits_correction.h
	@echo ---------   compilation de $@
	$(GPP) -c $< -o $@  $(CFLAGS)
...
$(OBJDIR)stars.o :   $(SRCDIR)stars.cpp $(SRCDIR)stars.h $(SRCDIR)main.h $(SRCDIR)MathlibD.h $(SRCDIR)button_callback.h $(SRCDIR)surveillance.h $(SRCDIR)var_mgr.h $(SRCDIR)Singleton.h $(SRCDIR)panel_courbe.h $(SRCDIR)console.h $(SRCDIR)panel_console_serial.h $(SRCDIR)serial.h $(SRCDIR)serveur_mgr.h $(SRCDIR)timer.h $(SRCDIR)star.h $(SRCDIR)panel_zoom.h $(SRCDIR)panel_camera.h $(SRCDIR)catalog.h $(SRCDIR)star_catalogue.h $(SRCDIR)convert.h $(SRCDIR)find_star.h $(SRCDIR)panel_graph.h $(SRCDIR)notification.h $(SRCDIR)panel_debug.h $(SRCDIR)panel_stdout.h
	@echo ---------   compilation de $@
	$(GPP) -c $< -o $@  $(CFLAGS)
